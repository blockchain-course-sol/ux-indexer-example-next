...
export const functions = {
  CANCEL_AUTHORIZATION_TYPEHASH: viewFun(
    "0xd9169487",
  ...
  RECEIVE_WITH_AUTHORIZATION_TYPEHASH: viewFun(
    "0x7f2eecc3",
  ...
  authorizationState: viewFun(
    ...
    { authorizer: p.address, nonce: p.bytes32 },
    p.bool
  ),
  balanceOf: viewFun(
    "0x70a08231",
  ...
  configureMinter: fun(
    ...
    { minter: p.address, minterAllowedAmount: p.uint256 },
    p.bool
  ),
  ...
  decreaseAllowance: fun(
    ...
    { spender: p.address, decrement: p.uint256 },
    p.bool
  ),
  increaseAllowance: fun(
    "0x39509351",
    "increaseAllowance(address,uint256)",
    { spender: p.address, increment: p.uint256 },
    p.bool
  ),
  initialize: fun(
    "0x3357162b",
  ...
  initializeV2: fun("0xd608ea64", "initializeV2(string)", {
    newName: p.string,
  }),
  initializeV2_1: fun("0x2fc81e09", "initializeV2_1(address)", {
    lostAndFound: p.address,
  }),
  isBlacklisted: viewFun(
    "0xfe575a87",
  ...
  mint: fun(
    ...
    { _to: p.address, _amount: p.uint256 },
    p.bool
  ),
  minterAllowance: viewFun(
    "0x8a6db9c3",
  ...
  rescueERC20: fun("0xb2118a8d", "rescueERC20(address,address,uint256)", {
  ...
  unBlacklist: fun("0x1a895266", "unBlacklist(address)", {
    _account: p.address,
  }),
  unpause: fun("0x3f4ba83a", "unpause()", {}),
  updateBlacklister: fun("0xad38bf22", "updateBlacklister(address)", {
    _newBlacklister: p.address,
  }),
  updateMasterMinter: fun("0xaa20e1e4", "updateMasterMinter(address)", {
    _newMasterMinter: p.address,
  }),
  updatePauser: fun("0x554bab3c", "updatePauser(address)", {
    _newPauser: p.address,
  }),
  updateRescuer: fun("0x2ab60045", "updateRescuer(address)", {
...
export class Contract extends ContractBase {
  ...
  authorizationState(
    authorizer: AuthorizationStateParams["authorizer"],
    nonce: AuthorizationStateParams["nonce"]
  ) {
...
export type AuthorizationCanceledEventArgs = EParams<
  typeof events.AuthorizationCanceled
>;
...
export type BlacklisterChangedEventArgs = EParams<
  typeof events.BlacklisterChanged
>;
export type BurnEventArgs = EParams<typeof events.Burn>;
export type MasterMinterChangedEventArgs = EParams<
  typeof events.MasterMinterChanged
>;
...
/// Function types
export type CANCEL_AUTHORIZATION_TYPEHASHParams = FunctionArguments<
  typeof functions.CANCEL_AUTHORIZATION_TYPEHASH
>;
export type CANCEL_AUTHORIZATION_TYPEHASHReturn = FunctionReturn<
  typeof functions.CANCEL_AUTHORIZATION_TYPEHASH
>;

export type DOMAIN_SEPARATORParams = FunctionArguments<
  typeof functions.DOMAIN_SEPARATOR
>;
export type DOMAIN_SEPARATORReturn = FunctionReturn<
  typeof functions.DOMAIN_SEPARATOR
>;
...
export type RECEIVE_WITH_AUTHORIZATION_TYPEHASHParams = FunctionArguments<
  typeof functions.RECEIVE_WITH_AUTHORIZATION_TYPEHASH
>;
export type RECEIVE_WITH_AUTHORIZATION_TYPEHASHReturn = FunctionReturn<
  typeof functions.RECEIVE_WITH_AUTHORIZATION_TYPEHASH
>;
...
export type CancelAuthorizationParams = FunctionArguments<
  typeof functions.cancelAuthorization
>;
export type CancelAuthorizationReturn = FunctionReturn<
  typeof functions.cancelAuthorization
>;

export type ConfigureMinterParams = FunctionArguments<
  typeof functions.configureMinter
>;
export type ConfigureMinterReturn = FunctionReturn<
  typeof functions.configureMinter
>;
...
export type DecreaseAllowanceParams = FunctionArguments<
  typeof functions.decreaseAllowance
>;
export type DecreaseAllowanceReturn = FunctionReturn<
  typeof functions.decreaseAllowance
>;

export type IncreaseAllowanceParams = FunctionArguments<
  typeof functions.increaseAllowance
>;
...
export type InitializeV2Params = FunctionArguments<
  typeof functions.initializeV2
>;
export type InitializeV2Return = FunctionReturn<typeof functions.initializeV2>;

export type InitializeV2_1Params = FunctionArguments<
  typeof functions.initializeV2_1
>;
export type InitializeV2_1Return = FunctionReturn<
  typeof functions.initializeV2_1
>;

export type IsBlacklistedParams = FunctionArguments<
  typeof functions.isBlacklisted
>;
export type IsBlacklistedReturn = FunctionReturn<
  typeof functions.isBlacklisted
>;
...
export type MasterMinterParams = FunctionArguments<
  typeof functions.masterMinter
>;
...
export type MinterAllowanceParams = FunctionArguments<
  typeof functions.minterAllowance
>;
export type MinterAllowanceReturn = FunctionReturn<
  typeof functions.minterAllowance
>;
...
export type ReceiveWithAuthorizationParams = FunctionArguments<
  typeof functions.receiveWithAuthorization
>;
export type ReceiveWithAuthorizationReturn = FunctionReturn<
  typeof functions.receiveWithAuthorization
>;

export type RemoveMinterParams = FunctionArguments<
  typeof functions.removeMinter
>;
...
export type UpdateBlacklisterParams = FunctionArguments<
  typeof functions.updateBlacklister
>;
export type UpdateBlacklisterReturn = FunctionReturn<
  typeof functions.updateBlacklister
>;

export type UpdateMasterMinterParams = FunctionArguments<
  typeof functions.updateMasterMinter
>;
export type UpdateMasterMinterReturn = FunctionReturn<
  typeof functions.updateMasterMinter
>;

export type UpdatePauserParams = FunctionArguments<
  typeof functions.updatePauser
>;
export type UpdatePauserReturn = FunctionReturn<typeof functions.updatePauser>;

export type UpdateRescuerParams = FunctionArguments<
  typeof functions.updateRescuer
>;
export type UpdateRescuerReturn = FunctionReturn<
  typeof functions.updateRescuer
>;
